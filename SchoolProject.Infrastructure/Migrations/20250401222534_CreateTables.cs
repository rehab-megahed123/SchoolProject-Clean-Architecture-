    ...
    public partial class CreateTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmantSubjects", x => x.DeptSubID);
                    table.ForeignKey(
                        name: "FK_DepartmantSubjects_Departments_DID",
                        column: x => x.DID,
                        principalTable: "Departments",
                        principalColumn: "DID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmantSubjects_Subjects_SubID",
                        column: x => x.SubID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmantSubjects_DID",
                table: "DepartmantSubjects",
                column: "DID");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmantSubjects_SubID",
                table: "DepartmantSubjects",
                column: "SubID");
